...
# Таких параграфов всегда 2 в сете dev set (distractor) (но предложений может быть больше, например, одно предложение в первом параграфе и два во втором), 
# в сете dev set (fullwiki) их разное колчество (датасет Hotpot)
