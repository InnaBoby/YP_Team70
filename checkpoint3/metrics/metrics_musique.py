# Musique
# Format of file with predictions (jsonl - each line is a dict as the following line): 
# {
#     "id": "question1_id", 
#     "predicted_answer": "predicted_answer", 
#     "predicted_support_idxs": [list of ids of paragraphs with supporting facts], 
#     "predicted_answerable": "True if there is an answer in paragraphs else False"
# }
# Format of file with gold answers (jsonl - each line is a dict as the following line): 
# {
#     "id": "question1_id", 
#     "answer": "answer", 
#     "answer_aliases": [list of answer aliases], 
#     "paragraphs": [{"idx": "id of paragraph", "is_supporting": "True if there is a suppoting fact in a paragraph else False"}, {...}], 
#     "answerable": "True if there is an answer in paragraphs else False"
# }
...
from musique_utils.group_answer_sufficiency import GroupAnswerSufficiencyMetric, AnswerMetric
from musique_utils.group_support_sufficiency import GroupSupportSufficiencyMetric, SupportMetric
